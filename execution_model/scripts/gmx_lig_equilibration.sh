...
gmx grompp -f ../inputs/gromacs_files/ligand/restrained_nvt.mdp -c lig_minimisation/lig_h_1~${ligand_2}/min.gro -p $ligand_top -o lig_nvt/lig_h_1~${ligand_2}/restrained_nvt.tpr
...
gmx grompp -f ../inputs/gromacs_files/ligand/nvt.mdp -c lig_nvt/lig_h_1~${ligand_2}/restrained_nvt.gro -p $ligand_top -o lig_nvt/lig_h_1~${ligand_2}/nvt.tpr
...
gmx grompp -f ../inputs/gromacs_files/ligand/restrained_npt.mdp -c lig_nvt/lig_h_1~${ligand_2}/nvt.gro -p $ligand_top -o lig_npt/lig_h_1~${ligand_2}/restrained_npt.tpr
...
gmx grompp -f ../inputs/gromacs_files/ligand/npt.mdp -c lig_npt/lig_h_1~${ligand_2}/restrained_npt.gro -p $ligand_top -o lig_npt/lig_h_1~${ligand_2}/npt.tpr
...
echo "NVT equilibration for 5 ps while restraining all non-solvent atoms"
gmx grompp -f ../inputs/gromacs_files/system/restrained_nvt.mdp -c sys_minimisation/lig_h_1~${ligand_2}/min.gro -p $system_top -o sys_nvt/lig_h_1~${ligand_2}/restrained_nvt.tpr
...
gmx grompp -f ../inputs/gromacs_files/system/bb_restrained_nvt.mdp -c sys_nvt/lig_h_1~${ligand_2}/restrained_nvt.gro -p $system_top -o sys_nvt/lig_h_1~${ligand_2}/bb_restrained_nvt.tpr
gmx mdrun -deffnm sys_nvt/lig_h_1~${ligand_2}/bb_restrained_nvt -nt 1 -nb gpu
echo "Finished backbone-restrained NVT"

echo "NVT equilibration for 50 ps without restraints"
gmx grompp -f ../inputs/gromacs_files/system/nvt.mdp -c sys_nvt/lig_h_1~${ligand_2}/bb_restrained_nvt.gro -p $system_top -o sys_nvt/lig_h_1~${ligand_2}/nvt.tpr
gmx mdrun -deffnm sys_nvt/lig_h_1~${ligand_2}/nvt -nt 1 -nb gpu
echo "Finished NVT"

echo "NPT equilibration for 200 ps while restraining non-solvent heavy atoms"
gmx grompp -f ../inputs/gromacs_files/system/restrained_npt.mdp -c sys_nvt/lig_h_1~${ligand_2}/nvt.gro -p $system_top -o sys_npt/lig_h_1~${ligand_2}/restrained_npt.tpr
gmx mdrun -deffnm sys_npt/lig_h_1~${ligand_2}/restrained_npt -nt 1 -nb gpu
echo "Finished restrained NPT"

echo "NPT equilibration for 200 ps without restraints"
gmx grompp -f ../inputs/gromacs_files/system/npt.mdp -c sys_npt/lig_h_1~${ligand_2}/restrained_npt.gro -p $system_top -o sys_npt/lig_h_1~${ligand_2}/npt.tpr
