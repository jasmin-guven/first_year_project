...
os.system("mkdir -p ../prep/test/ligands")
os.system("mkdir -p ../prep/test/protein")

print("Saving solvated/equilibrated systems.")
print("Ligand:")
print(equilibrated_ligand)
bss.IO.saveMolecules(f"../prep/test/ligands/{ligand_name}_ligand_prepped", equilibrated_ligand, ["PRM7", "RST7"])

print("Ligand + protein:")
print(equilibrated_system)
bss.IO.saveMolecules(f"../prep/test/protein/{lig_name}_system_prepped", equilibrated_system, ["PRM7", "RST7"])
